...
struct ProposalVotesView: View {
    ...
    var body: some View {
        HStack {
            Text("")
                .frame(width: proposalPercentages.yes, height: 50)
                .background(Color(UIColor.init(rgb: Int(Vote.yes.color))))
            
            Text("")
                .frame(width: proposalPercentages.no, height: 50)
                .background(Color(UIColor.init(rgb: Int(Vote.no.color))))
            
            Text("")
                .frame(width: proposalPercentages.noWithVeto, height: 50)
                .background(Color(UIColor.init(rgb: Int(Vote.noWithVeto.color))))
            
            Text("")
                .frame(width: proposalPercentages.abstain, height: 50)
